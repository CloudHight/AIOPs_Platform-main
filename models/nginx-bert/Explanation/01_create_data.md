# `models/nginx-bert/01_create_data.py` Explanation
...
- The default CLI output path is `data`, which keeps generated datasets local to `models/nginx-bert/` during notebook experimentation.
