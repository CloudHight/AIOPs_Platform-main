# `models/nginx-bert/04_deploy_model.py` Explanation
...
- The parser accepts `--instance-type`, and `deploy_production_model(...)` passes that value through to SageMaker deployment.
