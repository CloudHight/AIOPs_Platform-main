...
def create_dataset(output_file="cpu_time_series_realistic.csv"):
    ...
    print("  → Covers: true idle (0.5-1%), light idle (1-5%), medium (30-60%), high (65-80%)")
    ...
    print("  → Critical/crash range (85-100%)")

    print("\n✓ Clear separation: Normal ≤80%, Anomaly ≥85%")
    print("✓ RCF will learn: 'normal zone' (0.5-80%), 'anomaly zone' (85-100%)")
    print("✓ CPU at 2% (true idle) will be recognized as NORMAL")
    print("✓ CPU at 60% (medium load) will be recognized as NORMAL")
    print("======================================\n")
